...
import me.bedtrapteam.addon.util.autocrystalrewrite.*;
...
public class AutoCrystalRewrite extends Module {
    ...
    public AutoCrystalRewrite() {
        super(BedTrap.Combat, "auto-crystal-rewrite", "Automatically places and blows up crystals.");
    }
    ...
    private void doPlace(BlockPoz blockPos) {
        ...
        if (swap.get() == Swap.Silent) InvUtils.swapBack();
    ...
    public void onRender(Render3DEvent event) {
        if (renderMode.get() == RenderMode.Box) return;
