...
public class RPC extends Module {
    ...
    private final Setting<List<String>> line1Strings = sgLine1.add(new StringListSetting.Builder().name("line-1-messages").description("Messages used for the first line.").defaultValue("{player}","discord.gg/nc9qQSCHv2").onChanged(strings -> recompileLine1()).build());
