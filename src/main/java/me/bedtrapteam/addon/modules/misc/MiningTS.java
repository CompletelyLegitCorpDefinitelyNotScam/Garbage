...
import me.bedtrapteam.addon.modules.combat.AutoCrystalRewrite;
...
import me.bedtrapteam.addon.util.miningts.MTSUtils;
...
import static me.bedtrapteam.addon.util.miningts.MTSUtils.getBlocksAround;
...
public class MiningTS extends Module {
    ...
    public MiningTS() {
        super(BedTrap.Misc, "mining-TS", "Even I don't know why this module called like that.");
    }
    ...
    public void onActivate() {
        ...
        if (autoCity.get()) {
            ...
            if (TargetUtils.isBadTarget(target, 6)) {
                ...
                List<BlockPoz> blocks = getBlocksAround(target);
